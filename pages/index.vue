<template>
  <v-container>
    <ProgramList
      v-if="broadCastingPrograms && broadCastingPrograms.length > 0"
      class="mb-2"
      :title="'Đang chiếu'"
      :data="broadCastingPrograms"
    />
    <ProgramList
      v-if="todayNoonPrograms && todayNoonPrograms.length > 0"
      class="mb-2"
      :title="'Nổi bật trưa nay'"
      :data="todayNoonPrograms"
    />
    <ProgramList
      v-if="tonightPrograms && tonightPrograms.length > 0"
      class="mb-2"
      :title="'Nổi bật tối nay'"
      :data="tonightPrograms"
    />
    <ProgramList
      v-if="nextDayPrograms && nextDayPrograms.length > 0"
      class="mb-2"
